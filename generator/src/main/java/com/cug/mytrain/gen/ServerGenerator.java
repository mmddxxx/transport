package com.cug.mytrain.gen;

import com.cug.mytrain.util.DbUtil;
import com.cug.mytrain.util.Field;
import com.cug.mytrain.util.FreemarkerUtil;
...
//    static String serverPath = "[module]/src/main/java/com/cug/mytrain/[module]/";  //[module]是一个变量
    ...
    public static void main(String[] args) throws Exception {
        ...
        Node tableName = table.selectSingleNode("@tableName");  //查属性，得到表名和实体名
