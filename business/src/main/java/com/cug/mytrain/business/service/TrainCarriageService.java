...
public class TrainCarriageService {
    ...
    public void save(TrainCarriageSaveReq req) {
        ...
        if (ObjectUtil.isNull(trainCarriage.getId())) {
            ...
            // 保存之前，先校验唯一键是否存在
            TrainCarriage trainCarriageDB = getTrainCarriageByName(req.getTrainCode(), req.getIndex());
    ...
    private TrainCarriage getTrainCarriageByName(String trainCode, Integer index) {
