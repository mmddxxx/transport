...
import com.cug.mytrain.business.mapper.SkTokenMapper;
import com.cug.mytrain.business.mapper.cust.SkTokenMapperCust;
...
//    private String env;
    ...
    public boolean validSkToken(Date date, String trainCode, Long memberId) {
        ...
        try {
            ...
            boolean tryLock;
            tryLock = lock.tryLock(5, TimeUnit.SECONDS);  //带看门狗，可以无限期刷新时长，等待0s
            if (tryLock) {
